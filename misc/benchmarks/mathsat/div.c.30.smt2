...
(assert (let ((.def_191 (fp.leq b101 b98)))
(let ((.def_189 (fp.lt b98 b169)))
(let ((.def_187 (fp.leq b101 b95)))
(let ((.def_185 (fp.lt b95 b169)))
(let ((.def_183 (fp.leq b101 b92)))
(let ((.def_181 (fp.lt b92 b169)))
(let ((.def_179 (fp.leq b101 b89)))
(let ((.def_177 (fp.lt b89 b169)))
(let ((.def_175 (fp.leq b101 b86)))
(let ((.def_173 (fp.lt b86 b169)))
(let ((.def_171 (fp.leq b101 b83)))
(let ((.def_169 (fp.lt b83 b169)))
(let ((.def_167 (fp.leq b101 b80)))
(let ((.def_165 (fp.lt b80 b169)))
(let ((.def_163 (fp.leq b101 b77)))
(let ((.def_161 (fp.lt b77 b169)))
(let ((.def_159 (fp.leq b101 b74)))
(let ((.def_157 (fp.lt b74 b169)))
(let ((.def_155 (fp.leq b101 b71)))
(let ((.def_153 (fp.lt b71 b169)))
(let ((.def_151 (fp.leq b101 b68)))
(let ((.def_149 (fp.lt b68 b169)))
(let ((.def_147 (fp.leq b101 b65)))
(let ((.def_145 (fp.lt b65 b169)))
(let ((.def_143 (fp.leq b101 b62)))
(let ((.def_141 (fp.lt b62 b169)))
(let ((.def_139 (fp.leq b101 b59)))
(let ((.def_137 (fp.lt b59 b169)))
(let ((.def_135 (fp.leq b101 b56)))
(let ((.def_133 (fp.lt b56 b169)))
(let ((.def_131 (fp.leq b101 b53)))
(let ((.def_129 (fp.lt b53 b169)))
(let ((.def_127 (fp.leq b101 b50)))
(let ((.def_125 (fp.lt b50 b169)))
(let ((.def_123 (fp.leq b101 b47)))
(let ((.def_121 (fp.lt b47 b169)))
(let ((.def_119 (fp.leq b101 b44)))
(let ((.def_117 (fp.lt b44 b169)))
(let ((.def_115 (fp.leq b101 b41)))
(let ((.def_113 (fp.lt b41 b169)))
(let ((.def_111 (fp.leq b101 b38)))
(let ((.def_109 (fp.lt b38 b169)))
(let ((.def_107 (fp.leq b101 b35)))
(let ((.def_105 (fp.lt b35 b169)))
(let ((.def_103 (fp.leq b101 b32)))
(let ((.def_101 (fp.lt b32 b169)))
(let ((.def_99 (fp.leq b101 b29)))
(let ((.def_97 (fp.lt b29 b169)))
(let ((.def_95 (fp.leq b101 b26)))
(let ((.def_93 (fp.lt b26 b169)))
(let ((.def_91 (fp.leq b101 b23)))
(let ((.def_89 (fp.lt b23 b169)))
(let ((.def_87 (fp.leq b101 b20)))
(let ((.def_85 (fp.lt b20 b169)))
(let ((.def_83 (fp.leq b101 b17)))
(let ((.def_81 (fp.lt b17 b169)))
(let ((.def_79 (fp.leq b101 b14)))
(let ((.def_77 (fp.lt b14 b169)))
(let ((.def_75 (fp.leq b101 b11)))
