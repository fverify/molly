...
(let ((.def_24 (fp.leq .def_21 (fp #b0 #b10001101 #b11010100110000000000000))))
(let ((.def_70 (not .def_24)))
(let ((.def_68 (fp.leq .def_17 .def_20)))
...
(let ((.def_54 (fp.leq .def_53 (fp #b0 #b01101111 #b11110111010100010000010))))
(let ((.def_50 (fp.add RNE |c::main::1::a!0@1#1| .def_49)))
(let ((.def_51 (fp.leq .def_50 (fp #b0 #b01101111 #b11110111010100010000010))))
(let ((.def_43 (fp.neg |c::main::1::b!0@1#1|)))
(let ((.def_44 (fp.add RNE |c::main::1::a!0@1#1| .def_43)))
(let ((.def_47 (fp.leq .def_44 (fp #b0 #b01101111 #b11110111010100010000010))))
...
(let ((.def_37 (fp.lt (fp #b1 #b10000001000 #b1111010000000000000000000000000000000000000000000000) .def_34)))
(let ((.def_35 (fp.lt .def_34 (fp #b0 #b10000001000 #b1111010000000000000000000000000000000000000000000000))))
