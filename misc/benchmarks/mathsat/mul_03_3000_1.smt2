...
(let ((.def_24 (fp.leq .def_21 (fp #b0 #b10001010 #b01110111000000000000000))))
...
(let ((.def_54 (fp.leq .def_53 (fp #b0 #b01111101 #b00110011001100110011010))))
(let ((.def_50 (fp.add RNE |c::main::1::a!0@1#1| .def_49)))
(let ((.def_51 (fp.leq .def_50 (fp #b0 #b01111101 #b00110011001100110011010))))
(let ((.def_43 (fp.neg |c::main::1::b!0@1#1|)))
(let ((.def_44 (fp.add RNE |c::main::1::a!0@1#1| .def_43)))
(let ((.def_47 (fp.leq .def_44 (fp #b0 #b01111101 #b00110011001100110011010))))
