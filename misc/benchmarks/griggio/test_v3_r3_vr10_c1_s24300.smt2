...
(define-fun .31 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 0.171000003814697265625))
(define-fun .33 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 0.879000008106231689453))
(define-fun .34 () (_ FP 8 24) (* .3 .14 .33))
(define-fun .35 () (_ FP 8 24) (+ .3 .12 .34))
(define-fun .38 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero (- 0.537999987602233886719)))
(define-fun .39 () (_ FP 8 24) (* .3 .18 .38))
(define-fun .40 () (_ FP 8 24) (+ .3 .35 .39))
(define-fun .43 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero (- 0.767000019550323486328)))
(define-fun .44 () (_ FP 8 24) (* .3 .22 .43))
(define-fun .45 () (_ FP 8 24) (+ .3 .40 .44))
(define-fun .46 () Bool (<= .45 .31))
(assert .46)
(define-fun .48 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 0.225999996066093444824))
(define-fun .50 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 0.208000004291534423828))
(define-fun .51 () (_ FP 8 24) (* .3 .14 .50))
(define-fun .52 () (_ FP 8 24) (+ .3 .12 .51))
(define-fun .54 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 0.634999990463256835938))
(define-fun .55 () (_ FP 8 24) (* .3 .18 .54))
(define-fun .56 () (_ FP 8 24) (+ .3 .52 .55))
(define-fun .59 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero (- 0.674000024795532226563)))
(define-fun .60 () (_ FP 8 24) (* .3 .22 .59))
(define-fun .61 () (_ FP 8 24) (+ .3 .56 .60))
(define-fun .62 () Bool (<= .48 .61))
(assert .62)
(define-fun .64 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 0.929000020027160644531))
(define-fun .66 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 0.125))
(define-fun .67 () (_ FP 8 24) (* .3 .14 .66))
(define-fun .68 () (_ FP 8 24) (+ .3 .12 .67))
(define-fun .71 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero (- 0.104000002145767211914)))
(define-fun .72 () (_ FP 8 24) (* .3 .18 .71))
(define-fun .73 () (_ FP 8 24) (+ .3 .68 .72))
(define-fun .75 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 0.507000029087066650391))
(define-fun .76 () (_ FP 8 24) (* .3 .22 .75))
(define-fun .77 () (_ FP 8 24) (+ .3 .73 .76))
(define-fun .78 () Bool (<= .64 .77))
(assert .78)
(check-sat)
