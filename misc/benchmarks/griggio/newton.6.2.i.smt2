...
(define-fun .11 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero 1.20000004768371582031))
(define-fun .12 () Bool (< .9 .11))
(define-fun .14 () (_ FP 8 24) ((_ asFloat 8 24) roundTowardZero (- 1.20000004768371582031)))
