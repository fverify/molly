...
(define-fun .16 () (_ FP 11 53) ((_ asFloat 11 53) .3 .15))
(define-fun .17 () (_ FP 11 53) b20)
(define-fun .18 () Bool (< .17 .16))
(define-fun .19 () Bool (and .11 .18))
(define-fun .20 () (_ FP 8 24) b37)
(define-fun .21 () Bool (< .10 .20))
(define-fun .22 () Bool (and .19 .21))
(define-fun .23 () Bool (< .9 .12))
(define-fun .24 () Bool (and .22 .23))
(define-fun .25 () Bool (< .12 .20))
(define-fun .26 () Bool (and .24 .25))
(define-fun .27 () Bool (< .9 .14))
(define-fun .28 () Bool (and .26 .27))
(define-fun .29 () Bool (< .14 .20))
