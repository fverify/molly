...
(assert (and r1 r2 r3 r4 r5 r6 r7 r8 r9 r10 r11 r12 r13 r14))
;; define rhs: accumulation
(define-fun new () (_ Float 8 23) (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even a1 a2) a3) a4) a5) a6) a7) a8) a9) a10) a11) a12) a13) a14))
;; define lhs: reduction
(define-fun new1 () (_ Float 8 23) (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even a1 a2) (fpadd fp_round_nearest_even a3 a4)) (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even a5 a6) (fpadd fp_round_nearest_even a7 a8))) (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even (fpadd fp_round_nearest_even a9 a10) (fpadd fp_round_nearest_even a11 a12)) (fpadd fp_round_nearest_even a13 a14))))
