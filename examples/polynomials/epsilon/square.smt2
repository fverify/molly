(define-fun epsilon () (_ FloatingPoint 8 24) ((_ to_fp 8 24) RTN 0.00145))
...
(define-fun arithexp7 () (_ FloatingPoint 8 24) (fp.mul RNE a a))
...
(define-fun arithexp9 () (_ FloatingPoint 8 24) (fp.mul RNE a b))
...
(define-fun prop1 () Bool (fp.geq a const2))
...
(define-fun prop2 () Bool (fp.leq a const3))
(define-fun propexp2 () Bool (and prop1 prop2))
(define-fun prop3 () Bool (fp.geq b const2))
