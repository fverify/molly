(define-fun epsilon () (_ FloatingPoint 8 24) ((_ to_fp 8 24) RTN 0.0014046875))
...
(define-fun arithexp3 () (_ FloatingPoint 8 24) (fp.add RNE x a))
(assert (fp.isNormal arithexp3))
(declare-fun b () (_ FloatingPoint 8 24))
(assert (fp.isNormal b))
(define-fun arithexp4 () (_ FloatingPoint 8 24) (fp.add RNE x b))
...
(define-fun arithexp7 () (_ FloatingPoint 8 24) (fp.mul RNE x x))
(assert (fp.isNormal arithexp7))
(define-fun arithexp9 () (_ FloatingPoint 8 24) (fp.add RNE a b))
(assert (fp.isNormal arithexp9))
(define-fun arithexp8 () (_ FloatingPoint 8 24) (fp.mul RNE arithexp9 x))
...
(define-fun arithexp6 () (_ FloatingPoint 8 24) (fp.mul RNE a b))
...
(define-fun prop5 () Bool (fp.geq x const1))
(define-fun prop6 () Bool (fp.leq x const2))
